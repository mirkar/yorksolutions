...
I had to create the second scale set not in westus but in westus2, since westus doesn't have B1s image size available, and this is what I normally use in my exercises. Scale sets have capacity only 1 instance each to save resources.
